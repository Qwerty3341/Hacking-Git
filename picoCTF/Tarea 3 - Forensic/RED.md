...
## Solución
En los metadatos de la imagen viene un poema
```sh
$ exiftool red.png
...
File Access Date/Time           : 2025:05:11 14:02:51-06:00
File Inode Change Date/Time     : 2025:05:11 14:02:46-06:00
...
Megapixels                      : 0.016
```
Si usamos `zsteg` para ver si hay algo oculto nos sale esto:
```sh
$ zsteg red.png
...
b4,b,lsb,xy         .. file: 0421 Alliant compact executable not stripped
                    ..
```
Si lo desciframos con `base64` nos queda esto
```sh
