...
## Solución
Nos metemos al servidor que nos indican y nos lanza esto:
```
Encrypted message:
...
Ataque de un análisis de frecuencias usando Vigenère Solver (En el cipher variant le ponemos: Clasical Vigenere):
```
Zccltetyy bemnpgy:
