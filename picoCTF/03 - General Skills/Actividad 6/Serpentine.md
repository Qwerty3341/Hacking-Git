...
## Solución
El código nos da estas 3 opciones: 
```
...
```
Si le ponemos la 'b' lo único que hace es decirnos que se le olvidó llamar a la función así que desde el código fuente con nano podemos llamarla en la opción b. El código corregido quedaría así:
```python
import random
import sys
